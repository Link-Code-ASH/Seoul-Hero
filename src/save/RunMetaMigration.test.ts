...
it('migrates v8 through v11 meta state and removes permanent magic stones',()=>{
  ...
  expect(save.saveVersion).toBe(11); expect(save.meta.wallet.associationCoins).toBe(345);
