...
export const sfx = {
  ...
  critical: cue(['sfx/critical_01.wav','sfx/critical_02.wav'], '치명타', 'combat', 0.38, 0.1, 2, 4, [0.98, 1.02], 0.035),
  ...
  slashAttack: cue(['sfx/slash_01.wav','sfx/slash_02.wav'], '검격', 'combat', 0.21, 0.095, 2, 2, [0.97, 1.03], 0.04),
  orbitAttack: cue(['sfx/orbit_blade_01.wav','sfx/orbit_blade_02.wav'], '회전 표창', 'combat', 0.055, 0.34, 1, 1, [0.97, 1.02], 0.04),
  chainAttack: cue(['sfx/chain_discharge_01.wav','sfx/chain_discharge_02.wav'], '연쇄 번개', 'combat', 0.17, 0.25, 1, 2, [0.98, 1.02], 0.035),
  bombardAttack: cue(['sfx/explosion_arcane_01.wav','sfx/explosion_arcane_02.wav'], '마력 폭격', 'combat', 0.32, 0.16, 2, 3, [0.97, 1.02], 0.04),
  piercingAttack: cue(['sfx/piercing_01.wav','sfx/piercing_02.wav'], '관통 사격', 'combat', 0.19, 0.1, 2, 2, [0.97, 1.03], 0.04),
  turretFired: cue(['sfx/turret_soft_01.wav','sfx/turret_soft_02.wav'], '포탑 발사', 'combat', 0.09, 0.14, 2, 1, [0.98, 1.025], 0.035),
  minePlaced: cue(['sfx/mine_arm_01.wav'], '지뢰 설치', 'combat', 0.16, 0.16, 1, 1, [0.98, 1.02], 0.035),
  mineExploded: cue(['sfx/explosion_mine_01.wav','sfx/explosion_mine_02.wav'], '지뢰 폭발', 'combat', 0.32, 0.16, 2, 3, [0.97, 1.02], 0.04),
  fieldActivated: cue(['sfx/field_pulse_01.wav'], '마력장 작동', 'combat', 0.14, 0.22, 1, 1, [0.98, 1.02], 0.035),
  weaponFired: cue(['sfx/mana_bolt_01.wav','sfx/mana_bolt_02.wav','sfx/mana_bolt_03.wav'], '마력탄 발사', 'combat', 0.17, 0.065, 3, 2, [0.98, 1.03], 0.05),
