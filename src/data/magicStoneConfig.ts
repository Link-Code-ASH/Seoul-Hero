...
export const MAGIC_STONE_TIERS: Record<MagicStoneTier, { minValue: number; tint: number; scale: number }> = {
  1: { minValue: 0.9, tint: 0xeee8ff, scale: 0.92 },
  2: { minValue: 1.8, tint: 0xd6c2ff, scale: 1 },
  3: { minValue: 2.7, tint: 0xb58aef, scale: 1.08 },
  4: { minValue: 7.2, tint: 0x8d55cf, scale: 1.16 },
  5: { minValue: 18, tint: 0x63309e, scale: 1.26 },
};
