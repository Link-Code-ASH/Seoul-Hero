...
## 저장
브라우저에 협회 코인·생환석·해금·메타 진행·주간 상태·설정을 저장합니다. 현재 버전은 v12이며 구버전은 순서대로 검증·이관합니다. 새 판에서는 Run 마력석/무기/아이템이 초기화됩니다. 중간 전투 저장은 없습니다. 설정에 내보내기/가져오기/초기화가 있습니다. 주소나 브라우저를 바꾸면 저장 공간이 달라집니다.
